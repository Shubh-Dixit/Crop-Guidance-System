...
def load_components(version=DEFAULT_VERSION):
    rf_path = MODEL_DIR / f"rf_model-v{version}.pkl"
    xgb_path = MODEL_DIR / f"xgb_model-v{version}.pkl"
    ...
    try:
        ...
        if components["scaler"] and components["encoder"] and (components["rf"] or components["xgb"]):
            meta["loaded"] = True
